/* Subroutines for the Rust front end for the Motorola 680x0/ColdFire
architecture. Copyright (C) 2020 Free Software Foundation, Inc.
...
void
m68k_rust_target_cpu_info (void)
{
