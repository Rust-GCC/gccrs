...
void m32r_rust_target_cpu_info(void) {
    ...
    // TODO: find way to have flush-func and flush-trap (they don't work well as defines)
    ...
    // TODO: couldn't find any option on "-G" even though docs mention it - maybe check that?
}
