...
void avr_rust_target_features_avr0(void) {}

/* Target features for AVR1 targets.  */

void avr_rust_target_features_avr1(void) {
    avr_rust_target_features_avr0();
}

/* Target features for AVR2 targets.  */

void avr_rust_target_features_avr2(void) {
...
void avr_rust_target_features_avr25(void) {
...
void avr_rust_target_features_avrtiny(void) {
    avr_rust_target_features_avr0();
...
void avr_rust_target_features_avrxmega(void) {
    avr_rust_target_features_avr0();
