...
void
riscv_rust_target_cpu_info (void)
{
  if (TARGET_64BIT)
  ...
  /* TODO: maybe add gcc features with no llvm equivalent, e.g. align-data,
   * riscv-attribute, explicit-relocs, strict-align, cmodel, small-data-limit,
   * branch-cost, plt, abi, preferred-stack-boundary, fdiv, div */
}
