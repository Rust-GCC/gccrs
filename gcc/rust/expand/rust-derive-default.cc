...
{
  auto default_trait = builder.type_path ({builder.get_path_start(), "default", "Default"}, true);
...
{
  auto default_path = builder.type_path ({builder.get_path_start(), "default", "Default"}, true);
