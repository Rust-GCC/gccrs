...
{
  begin_internal_comment ("NamedFunctionParam");
  ...
  end_internal_comment ("NamedFunctionParam");
}
...
{
  begin_internal_comment ("TraitItemConst");
  ...
  end_internal_comment ("TraitItemConst");
}
