...
public:
					...
					VARIANCE variance)
  {
	...
	return add_constraints_from_ty (type, variance);
      case Mutability::Mut:
	return add_constraints_from_ty (type, V::invariant ());
      }
  }
  virtual void
...
public:
  ...
  void visit (FnType &type) override
  {
    for (auto &region : type.get_used_arguments ().get_regions ())
      ctx.add_constraints_from_region (region, V::invariant ());
  }
...
/** Visitor context for generic type variance analysis. */
...
public: // External API
  ...
  static GenericTyVisitorCtx &get ();
...
public: // Global context
  /** Singleton instance. */
  static GenericTyVisitorCtx *instance;
