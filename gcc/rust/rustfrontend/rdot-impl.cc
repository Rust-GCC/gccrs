...
static const char * opcodeStrings [] = {
  ...
  /* [D_STRUCT_INIT_ARGUMENT] */ "struct_initilizations_argument" 
...
rdot rdot_build_varDecl (rdot type, bool mut, rdot id)
{
...
CompilationUnitAst::CompilationUnitAst() : m_nodes() { }

CompilationUnitAst::~CompilationUnitAst() { }

CompilationUnitAst& CompilationUnitAst::CompilationUnitAst::get() {
    static CompilationUnitAst instance;
    return instance;
}

void CompilationUnitAst::addNode(rdot node) {
    m_nodes.push_back(node);
}

std::vector<rdot> CompilationUnitAst::getNodes() {
    return m_nodes;
}
