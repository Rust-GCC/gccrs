...
void rust_be_get_quotechars(const char **open_qu, const char **close_qu)
{
  *open_qu = open_quote;
...
void rust_be_internal_error_at(const Location location, const std::string &errmsg)
{
...
void rust_internal_error_at(const Location location, const char *fmt, ...)
{
  va_list ap;
...
void rust_be_error_at(const Location location, const std::string &errmsg)
{
  location_t gcc_loc = location.gcc_location();
  error_at(gcc_loc, "%s", errmsg.c_str());
}

void rust_error_at(const Location location, const char *fmt, ...)
{
  va_list ap;
...
void rust_be_error_at(const RichLocation &location, const ErrorCode code,
...
void rust_error_at(const RichLocation &location, const ErrorCode code,
                   const char *fmt, ...)
{
  va_list ap;
...
void rust_be_warning_at(const Location location, int opt,
...
void rust_warning_at(const Location location, int opt, const char *fmt, ...)
{
  va_list ap;
...
void rust_be_fatal_error(const Location location, const std::string &fatalmsg)
{
  location_t gcc_loc = location.gcc_location();
  fatal_error(gcc_loc, "%s", fatalmsg.c_str());
}

void rust_fatal_error(const Location location, const char *fmt, ...)
{
  va_list ap;
...
void rust_be_inform(const Location location, const std::string &infomsg)
{
  location_t gcc_loc = location.gcc_location();
  inform(gcc_loc, "%s", infomsg.c_str());
}

void rust_inform(const Location location, const char *fmt, ...)
{
  va_list ap;
...
// Rich Locations
void rust_be_error_at(const RichLocation &location, const std::string &errmsg)
{
  /* TODO: 'error_at' would like a non-'const' 'rich_location *'.  */
  rich_location &gcc_loc = const_cast<rich_location &>(location.get());
  error_at(&gcc_loc, "%s", errmsg.c_str());
...
void rust_error_at(const RichLocation &location, const char *fmt, ...)
{
  va_list ap;
