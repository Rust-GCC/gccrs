...
public:
  ...
  static Constructor make_wildcard () { return Constructor (WILDCARD); }

  static Constructor make_reference () { return Constructor (REFERENCE); }
  ...
  {
    rust_assert (kind == VARIANT || kind == STRUCT);
    return variant_idx;
  }
