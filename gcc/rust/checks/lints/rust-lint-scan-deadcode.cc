...
void
ScanDeadcode::Scan (HIR::Crate &crate)
{
...
void
ScanDeadcode::visit (HIR::Function &function)
{
...
void
ScanDeadcode::visit (HIR::StructStruct &stct)
{
...
void
ScanDeadcode::visit (HIR::TupleStruct &stct)
{
...
void
ScanDeadcode::visit (HIR::ImplBlock &blc)
{
...
void
ScanDeadcode::visit (HIR::Module &mod)
{
...
bool
ScanDeadcode::should_warn (HirId hirId)
{
