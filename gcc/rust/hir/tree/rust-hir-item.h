...
protected:
  // Constructor
  Item (Analysis::NodeMapping mappings, bool is_derived,
...
protected:
  ...
  VisItem (Analysis::NodeMapping mappings, bool is_derived,
	   Visibility visibility, AST::AttrVec outer_attrs = AST::AttrVec ())
...
public:
  ...
  Module (Analysis::NodeMapping mappings, Identifier module_name,
	  ...
	  bool is_derived, Visibility visibility = Visibility::create_error (),
...
protected:
  Struct (Analysis::NodeMapping mappings, Identifier struct_name,
	  ...
	  bool is_derived, AST::AttrVec outer_attrs = AST::AttrVec ())
