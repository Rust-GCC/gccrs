...
Dump::visit (OffsetOf &e)
{
  ...
  put_field ("type", e.get_type ().to_string ());
...
Dump::visit (TypeAlias &e)
{
  ...
  put_field ("type", e.get_type_aliased ().to_string ());
...
Dump::visit (ReferencePattern &e)
{
  ...
  do_mappings (e.get_mappings ());
  put_field ("mut", std::to_string (e.is_mut ()));
  put_field ("pattern", e.get_referenced_pattern ().to_string ());
...
Dump::visit (ParenthesisedType &e)
{
  ...
  do_type (e);
  put_field ("type_in_parens", e.get_type_in_parens ().to_string ());
...
Dump::visit (ReferenceType &e)
{
  ...
  put_field ("mut", enum_to_str (e.get_mut ()));
  put_field ("type", e.get_base_type ().to_string ());
  end ("ReferenceType");
}
