...
extern {
   ...
   pub fn life2<'b>(x:&'a i32, y:&'b i32); // { dg-error ".E0261." "" { target *-*-* } }
   pub fn life3<'a>(x:&'a i32, y:&i32) -> &'a i32;
   pub fn life4<'b>(x: for<'c> fn(&'a i32)); // { dg-error ".E0261." "" { target *-*-* } }
   pub fn life5<'b>(x: for<'c> fn(&'b i32));
   pub fn life6<'b>(x: for<'c> fn(&'c i32));
   pub fn life7<'b>() -> for<'c> fn(&'a i32); // { dg-error ".E0261." "" { target *-*-* } }
