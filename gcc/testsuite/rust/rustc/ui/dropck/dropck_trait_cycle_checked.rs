...
fn f() {
    ...
    o1.set0(&o2); // { dg-error ".E0597." "" { target *-*-* } }
    o1.set1(&o3); // { dg-error ".E0597." "" { target *-*-* } }
    o2.set0(&o2); // { dg-error ".E0597." "" { target *-*-* } }
    o2.set1(&o3); // { dg-error ".E0597." "" { target *-*-* } }
    o3.set0(&o1); // { dg-error ".E0597." "" { target *-*-* } }
    o3.set1(&o2); // { dg-error ".E0597." "" { target *-*-* } }
}
