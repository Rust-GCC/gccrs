...
fn main() {
    ...
    let _: <B<()> as Tr>::Ty = 0u8;   // { dg-error ".E0308." "" { target *-*-* } }
    let _: <B<()> as Tr>::Ty = true;  // { dg-error ".E0308." "" { target *-*-* } }
    let _: <B2<()> as Tr>::Ty = 0u8;  // { dg-error ".E0308." "" { target *-*-* } }
    let _: <B2<()> as Tr>::Ty = true; // { dg-error ".E0308." "" { target *-*-* } }
