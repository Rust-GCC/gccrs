...
fn b() { dent(ModelT, Blue); } // { dg-error ".E0308." "" { target *-*-* } }
fn c() { dent(ModelU, Black); } // { dg-error ".E0308." "" { target *-*-* } }
fn d() { dent(ModelU, Blue); }

fn e() { ModelT.chip_paint(Black); }
fn f() { ModelT.chip_paint(Blue); } // { dg-error ".E0308." "" { target *-*-* } }
fn g() { ModelU.chip_paint(Black); } // { dg-error ".E0308." "" { target *-*-* } }
